            ...
            <div className="relative">
                <div className="rounded-3xl overflow-hidden h-[76vh] md:max-h-[550px] lg:max-h-[700px] transform scale-x-[-1]">
                    <img
                        src="/hero-image.jpg"
                        alt="hero-image"
                        className="h-full rounded-2xl overflow-hidden w-full transform object-[64%_bottom] object-cover"
                    />
                ...
                <div className="flex flex-col lg:flex-row justify-end lg:justify-between absolute inset-0 p-4 sm:p-6 md:p-10 lg:p-16 items-center lg:items-end gap-8 lg:gap-4">
                    <div className="space-y-6 max-w-full lg:max-w-[54%] text-center lg:text-left">
                        <h1 className="text-white font-normal text-[22px] sm:text-4xl md:text-5xl lg:text-[54px] leading-tight lg:leading-15">From Insight to<br /> Impact in Health systems</h1>
                    ...
                    <div className="hidden lg:flex flex-col space-y-5 w-full lg:w-auto items-center lg:items-start">
                        <div className="flex flex-row gap-4 items-stretch justify-center lg:justify-start">
                            <Card className="w-full lg:min-w-72 py-0 flex flex-col">
                                <CardContent className="flex justify-between items-center relative px-0 overflow-hidden flex-1">
                                    <div className="space-y-6 lg:space-y-8 p-4 lg:p-5">
                            ...
                            <Card className="w-full lg:max-w-[185px] flex flex-col gap-6 py-2.5">
                                <CardHeader className="flex gap-3 px-4 lg:px-5 py-4">
                                ...
                                <CardContent className="px-4 lg:px-5 pb-4 lg:pb-5 flex-1">
                                    <h3 className="text-2xl lg:text-[32px]">65%</h3>
                                    <span className="text-xs lg:text-sm">of rural counties face provider shortages</span>
                                </CardContent>
                            </Card>
                        </div>
                        <div className="flex gap-4 lg:gap-6 rounded-full backdrop-blur-[16px] shadow-[inset_-1px_-1px_2px_0px_#FFFFFF29,inset_1px_1px_2px_0px_#FFFFFF4D] py-2 px-4 lg:px-5">
                            <h5 className="text-white font-medium text-[11px] lg:text-[13px] leading-5 lg:leading-6">Partnership engagements developing across 45+ communities</h5>
                            <Users className="text-white w-5 lg:w-6 h-5 lg:h-6 flex-shrink-0" />
                        </div>
                    </div>
                </div>
            </div>
