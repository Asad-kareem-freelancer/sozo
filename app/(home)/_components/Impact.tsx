    ...
    return (
        <section className="py-8 md:py-10 xl:py-14">
            <Container variant="compact">
                <div className="grid grid-cols-1 xl:grid-cols-2 justify-between gap-6 md:gap-8 xl:gap-[188px]">
                    ...
                    <div className="mt-6 xl:mt-0 flex flex-col">
                        ...
                        <span className="block mb-4 md:mb-5 xl:mb-6 text-sm md:text-base">The SozoRock Foundation develops field-tested models that translate research into measurable outcomes.</span>
                        <div className="divide-y divide-gray-200 flex flex-col justify-between grow">
                            <div className="py-2 md:py-3 xl:py-4 space-y-1 xl:space-y-2">
                            ...
                            <div className="py-2 md:py-3 xl:py-4 space-y-1 xl:space-y-2">
                                <span className="block text-sm md:text-base"><b>Library Health Equity Hub&trade;</b> — A scalable model transforming local libraries into trusted community health access points for telehealth, translation, and literacy programs.</span>
                                <Link href="/" className="text-[#009E9B] underline text-sm inline-block">Explore the Hub</Link>
                            </div>

                            <div className="pt-2 md:pt-3 xl:pt-4 space-y-1 xl:space-y-2">
