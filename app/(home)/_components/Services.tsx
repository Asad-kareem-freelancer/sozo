            ...
            <Container variant="compact">
                <div className="space-y-8 md:space-y-12">
                    <div className="space-y-3 md:space-y-4">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[44px] font-bold">What We Do</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <Card className="bg-[#F0F6F6]/60 transition-shadow hover:shadow-lg">
                            <CardHeader>
                                <h2 className="text-xl md:text-2xl font-semibold">01. Research & Publications</h2>
                            </CardHeader>
                        ...
                        <Card className="bg-[#F0F6F6]/60 transition-shadow hover:shadow-lg">
                            <CardHeader>
                                <h2 className="text-xl md:text-2xl font-semibold">02. Programs & Pilots</h2>
                            </CardHeader>
                            <CardContent className="bg-white/40">
                        ...
                        <Card className="bg-[#F0F6F6]/60 transition-shadow hover:shadow-lg md:col-span-2 lg:col-span-1">
                            <CardHeader>
                                <h2 className="text-xl md:text-2xl font-semibold">03. People & Partnerships</h2>
                            </CardHeader>
                            <CardContent className="bg-white/40">
