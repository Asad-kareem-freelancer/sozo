            ...
            <Container variant="compact">
                <div className="space-y-8 md:space-y-12">
                    <div className="space-y-3 md:space-y-4">
                        ...
                        <span className="block text-sm sm:text-base md:text-lg leading-relaxed md:max-w-[946px]">The SozoRock® Foundation transforms research into measurable change - designing scalable models for health systems equity, access, and leadership</span>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        ...
                        <Card className="bg-[#F0F6F6]/60 transition-shadow hover:shadow-lg md:col-span-2 lg:col-span-1">
                            ...
                            <CardContent className="bg-white/40">
                                <p className="text-sm md:text-base leading-relaxed">Aligning universities, providers, and communities to drive measurable impact across health systems</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
