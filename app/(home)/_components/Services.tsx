            ...
            <Container variant="compact">
                <div className="space-y-10 md:space-y-12">
                    <div className="space-y-4">
                        ...
                        <span className="block text-base md:text-lg leading-relaxed md:max-w-[946px]">The SozoRock® Foundation transforms research into measurable change - designing scalable models for health systems equity, access, and leadership</span>
                    </div>
