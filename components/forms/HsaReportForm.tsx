...
import { useHsaReportForm } from './hooks/useHsaReportForm';
...
export default function HsaReportForm({ onOpenChange }: Props) {
  const { register, onSubmit, errors, control, isSubmitting, handleSubmit, watch, setValue, trigger } = useHsaReportForm();
